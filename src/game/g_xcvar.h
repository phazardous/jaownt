...
XCVAR_DEF( bg_infammo,					"0",			NULL,				CVAR_ARCHIVE|CVAR_SYSTEMINFO,					qtrue )
XCVAR_DEF( bg_superweapons,				"1",			NULL,				CVAR_ARCHIVE|CVAR_SYSTEMINFO,					qtrue )
...
XCVAR_DEF( g_physresolution,			"125",			G_Phys_Update_CvarRes,	CVAR_ARCHIVE|CVAR_SERVERINFO,				qtrue )
