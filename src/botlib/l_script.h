...
int PS_ExpectTokenString(script_t *script, char const *string);
...
void QDECL ScriptError(script_t *script, char const *str, ...) __attribute__ ((format (printf, 2, 3)));
//print a script warning with filename and line number
void QDECL ScriptWarning(script_t *script, char const *str, ...) __attribute__ ((format (printf, 2, 3)));
